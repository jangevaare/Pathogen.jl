...
Examples of Pathogen.jl workflow are included in the examples directory as a Jupyter notebook.
1. [SIR simulation, inference, and visualization](examples/SIR.ipynb)
